    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('designations.update', [$designation->id]) }}" style='font-size:10px'>
                        ...
                        <div class="form-group row">
                            <div class="input-group input-group-sm col-md-12"  style='margin-top:-10px'>
                                ...
                                <input id="organization" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $designation->name }}" required>
