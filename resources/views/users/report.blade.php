...
<div class="container-fluid">
	<div class="row" >
		...
		<div class="col-md-12 col-lg-6">
			...
			<div class='row'  id='step1-complete' style='display:none'>
				<div class="d-flex justify-content-between align-items-center m-4 border border-primary badge badge-pill w-100">
					<span class='text-muted'> <button class='btn btn-outline-secondary rounded-circle shadow-sm' disabled><</button> &nbsp;Back</span>
					<span class='text-primary'> Save and Proceed <button class='btn btn-primary rounded-circle shadow-sm'>></button></span>
				</div>
			</div>
		</div>
	</div>
